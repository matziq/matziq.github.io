...
window.AB1_DATA.drills = [
    ...
    "questions": [
      ...
      },
      {
        ...
        "choices": [
          ...
          "Supported only in the standalone Agentic AI Business Solutions Architect CLI",
  ...
  },
  {
    ...
    "blurb": "Connects the standalone Agentic AI Business Solutions Architect CLI to interactive sessions, prompt mode, and platform support.",
    "timeMinutes": 10,
    "questions": [
      {
        "n": 1,
        ...
        "choices": [
          "Agentic AI Business Solutions Architect CLI",
        ...
        "answer": 0,
        "tag": "CLI name",
        "explanation": "<p>Agentic AI Business Solutions Architect CLI is right because the current CLI is standalone and works in terminal workflows. The gh copilot extension phrasing is retired terminology. Copilot Spark was retired. Copilot knowledge bases were retired and replaced by Copilot Spaces.</p>"
      },
      {
        "n": 2,
      ...
      {
        "n": 4,
        "prompt": "A team asks where Agentic AI Business Solutions Architect CLI can run. Which platform statement is supported?",
        "choices": [
      ...
      },
      {
        ...
        "answer": 2,
        "tag": "Plan inclusion",
        "explanation": "<p>All plans include Copilot CLI is right according to the plan facts. Enterprise is not the only plan. Copilot Spaces are unrelated to CLI inclusion. Copilot Extensions were retired, but the standalone Agentic AI Business Solutions Architect CLI is current.</p>"
      },
      {
        "n": 6,
        ...
        "choices": [
          "Use Agentic AI Business Solutions Architect CLI interactively and in sessions",
        ...
        "answer": 0,
        "tag": "CLI objective",
        "explanation": "<p>Using Agentic AI Business Solutions Architect CLI interactively and in sessions is right because the objective includes sessions, scripts, and file management. Privacy exclusions are a different domain. Responsible AI principles are important but not the CLI feature objective. Code review policies are administrator settings.</p>"
      },
      {
        "n": 7,
    ...
    "questions": [
      ...
      },
      {
        ...
        "choices": [
          ...
          "It does not require a Agentic AI Business Solutions Architect subscription"
        ],
        "answer": 3,
        "tag": "Autofix",
        "explanation": "<p>Not requiring a Agentic AI Business Solutions Architect subscription is right for Copilot Autofix for CodeQL alerts. It is not limited to Enterprise subscribers. Public-code matching does not enable Autofix. The suggestion still needs review even though it includes code and explanation.</p>"
      },
      {
        "n": 5,
    ...
    "questions": [
      ...
      },
      {
        ...
        "choices": [
          ...
          "As the new name for Agentic AI Business Solutions Architect CLI"
        ],
        "answer": 1,
        "tag": "Spark retirement",
        "explanation": "<p>Covering Copilot Spark as retired is right because the feature is no longer live. It is not the current app builder, did not replace Spaces, and is not the new name for Agentic AI Business Solutions Architect CLI. Current replacements include building directly with VS Code, Copilot CLI, and the Agentic AI Business Solutions Architect app.</p>"
      },
      {
        "n": 4,
  ...
  },
  {
    ...
    "questions": [
      ...
      },
      {
        ...
        "choices": [
          "The 28-day figure applies only to the Agentic AI Business Solutions Architect CLI",
  ...
  },
  {
    ...
    "questions": [
      ...
      },
      {
        ...
        "choices": [
          "Agentic AI Business Solutions Architect Developer Survey",
        ...
        "answer": 0,
        "tag": "Survey",
        "explanation": "<p>Agentic AI Business Solutions Architect Developer Survey is right because it is named as a source for measuring impact. Copilot Spark export is tied to a retired product. GitHub Enterprise Server does not support Copilot. Exam Replay is a discount offer, not the named developer survey.</p>"
      },
      {
        "n": 7,
        "prompt": "How often can the long-form Agentic AI Business Solutions Architect Developer Survey be sent according to the facts brief?",
        "choices": [
          "Every day",
          "Every two weeks",
  ...
  },
  {
    ...
    "questions": [
      ...
      {
        "n": 3,
        "prompt": "What conditions are required for Agentic AI Business Solutions Architect IP indemnity according to the facts brief?",
        "choices": [
      ...
      },
      {
        ...
        "choices": [
          ...
          "IP indemnity, Data Protection Agreement, and Agentic AI Business Solutions Architect Trust Center"
        ],
        "answer": 3,
        "tag": "Protections",
        "explanation": "<p>IP indemnity, Data Protection Agreement, and Agentic AI Business Solutions Architect Trust Center are right because those are the three named contractual protections. Exam logistics, retired features, and technical concepts such as ghost text, FIM, and LoRA are not that protection set.</p>"
      },
      {
        "n": 5,
      ...
      },
      {
        ...
        "answer": 0,
        "tag": "Audit retention",
        "explanation": "<p>180 days is right for audit-log retention. 28 days is the typical retention for chat outside the editor. 100 minutes is the AB-100 exam time limit. Five attempts is part of the Microsoft retake policy.</p>"
      },
      {
        "n": 7,
