window.AB1_DATA = window.AB1_DATA || {};

window.AB1_DATA.exam1 = {
  id: "exam1",
  name: "AB-100 \u2014 Practice Exam 1",
  timeMinutes: 100,
  units: [ { title: "", html: "", questions: [
    ...
    },
    {
      ...
      choices: ["Agent mode in the IDE", "Copilot cloud agent", "Suggestions matching public code", "Agentic AI Business Solutions Architect code referencing"],
      answer: 0,
    ...
    {
      n: 11,
      prompt: "<p>An engineering director wants to measure Copilot usage and coding impact over time. Which metric is specifically named in Agentic AI Business Solutions Architect usage measurement guidance?</p>",
    ...
    },
    {
      ...
      choices: ["Copilot Autofix is unavailable without a paid Copilot seat.", "Only Copilot Enterprise can generate a fix for CodeQL alerts.", "The team must enable Copilot cloud agent first.", "Copilot Autofix for CodeQL analysis does not require a Agentic AI Business Solutions Architect subscription."],
      answer: 3,
      topic: "Testing and Security",
      objective: "5.2",
      difficulty: "easy",
      explanation: "<p>Copilot Autofix for code scanning automatically generates fix suggestions for CodeQL alerts on pull requests and the default branch, and it does not require a Agentic AI Business Solutions Architect subscription.</p><p>A paid Copilot seat, Copilot Enterprise, and Copilot cloud agent are not prerequisites for this specific CodeQL Autofix capability. Assuming a Copilot subscription is required is a known trap.</p>"
    },
    {
      n: 13,
    ...
    {
      n: 18,
      prompt: "<p>A developer wants to run Agentic AI Business Solutions Architect CLI non-interactively from a script by passing a prompt directly. Which option is designed for that use?</p>",
    ...
    },
    {
      ...
      objective: "2.3",
      difficulty: "medium",
      explanation: "<p>Copilot Spaces are the current feature for organizing reusable context such as documentation. The retired knowledge bases feature was replaced by Copilot Spaces.</p><p>Retired knowledge bases are no longer the current capability. GitHub App-based Copilot Extensions were sunset and replaced by MCP servers for that extensibility model. GitHub Enterprise Server does not currently support Agentic AI Business Solutions Architect.</p>"
    },
    {
      n: 20,
    ...
    {
      n: 32,
      prompt: "<p>In Agentic AI Business Solutions Architect CLI, a developer wants to cycle into plan mode during an interactive session. Which key sequence is documented for cycling modes?</p>",
      choices: ["Ctrl+P", "Alt+Enter", "Esc twice", "Shift+Tab"],
      answer: 3,
      topic: "Copilot CLI",
      objective: "2.2",
      difficulty: "easy",
      explanation: "<p>Agentic AI Business Solutions Architect CLI includes a plan mode, and Shift+Tab cycles modes during an interactive session. This lets a developer change how the CLI approaches the task.</p><p>Ctrl+P, Alt+Enter, and pressing Esc twice are plausible terminal or editor shortcuts, but they are not the documented Copilot CLI mode-cycling shortcut in the facts brief.</p>"
    },
    {
      n: 33,
    ...
    {
      n: 34,
      prompt: "<p>An enterprise wants to allow the Copilot app but block Agentic AI Business Solutions Architect CLI. What policy fact makes this possible?</p>",
      ...
      objective: "2.4",
      difficulty: "medium",
      explanation: "<p>The Copilot app and Agentic AI Business Solutions Architect CLI are governed by separate, independent client policies. An enterprise can allow one client while disallowing the other.</p><p>Personal custom instructions do not determine client availability. Suggestions matching public code is a content safeguard, not the CLI availability policy. Enabling Copilot Chat does not automatically force the app to be enabled.</p>"
    },
    {
      n: 35,
    ...
    },
    {
      ...
      choices: ["The billing receipt and exam transcript", "The repository star count and branch list", "The REST API for Copilot usage metrics and the Agentic AI Business Solutions Architect Developer Survey", "The local shell history and browser cache"],
      answer: 2,
      topic: "Productivity and Code Quality",
      objective: "5.1",
      difficulty: "medium",
      explanation: "<p>The facts brief names the REST API for Copilot usage metrics and the Agentic AI Business Solutions Architect Developer Survey as sources for measuring impact through the evaluation stages.</p><p>Billing receipts, exam transcripts, stars, branch lists, shell history, and browser cache may contain other information, but they are not the named Copilot impact measurement sources.</p>"
    },
    {
      n: 40,
    ...
    {
      n: 46,
      prompt: "<p>A developer wants to use Agentic AI Business Solutions Architect CLI on a Windows workstation. Which environment is supported?</p>",
      ...
      objective: "2.2",
      difficulty: "medium",
      explanation: "<p>Agentic AI Business Solutions Architect CLI runs on Linux, macOS, and Windows, including Windows PowerShell and WSL. That makes it suitable for a Windows workstation terminal workflow.</p><p>A Linux-only container, NeoVim over SSH, and GitHub Mobile are not the stated Windows CLI support path. Mobile and editor contexts are distinct from the standalone CLI.</p>"
    },
    {
      n: 47,
      ...
      choices: ["As the primary current way to build new apps with Copilot", "As the replacement for MCP servers", "As a retired feature, with current work moving to VS Code, Copilot CLI, and the Agentic AI Business Solutions Architect app", "As a GitHub Enterprise Server-only feature"],
      answer: 2,
      topic: "Copilot Features and Capabilities",
      objective: "2.3",
      difficulty: "hard",
      explanation: "<p>Copilot Spark should be covered only as a retired feature. The current replacement framing is to build directly with Copilot in VS Code, Agentic AI Business Solutions Architect CLI, and the Agentic AI Business Solutions Architect app.</p><p>It should not be presented as the current primary way to build new apps. It did not replace MCP servers. It is not a GitHub Enterprise Server-only feature, and Copilot is not currently available for GitHub Enterprise Server.</p>"
    },
    {
      n: 48,
