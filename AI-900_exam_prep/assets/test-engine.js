/* ============================================================
   AI-900 Exam Prep  |  practice exam engine
...
(function (global) {
    ...
    Engine.prototype.renderSectionIntro = function () {
        ...
        wrap.innerHTML =
            ...
            '<div class="badge accent">' + (this.sections.length > 1
                ...
                : "AI-900 \u00b7 Azure AI Fundamentals") + "</div>" +
    ...
    Engine.prototype.renderResults = function () {
        ...
        if (isDrill) {
            ...
            wrap.appendChild(el("div", "score-hero",
                '<div class="composite-label">Estimated scaled score \u00b7 AI-900</div>' +
